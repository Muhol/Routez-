...
- [x] **3.1 Home Screen Map & Interactions (`lib/features/home/presentation/screens/home_screen.dart`)**
  ...
  - Remove quick action buttons (*"Home"*, *"Work"*, *"Popular"*).
...
- [x] **3.2 Active Trip Navigation Wizard (`lib/features/active_trip/presentation/screens/active_trip_screen.dart`)**
