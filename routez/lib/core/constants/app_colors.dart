...
class AppColors {
  ...
  static Color glassBackgroundDark = const Color.fromARGB(255, 24, 24, 24).withValues(alpha: 0.50);
  static Color glassBorderDark = const Color.fromARGB(44, 117, 117, 117).withValues(alpha: 0.18);
